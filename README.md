...
Currently, the only comic book database the provides a REST API for users is [Comic Vine](https://comicvine.gamespot.com/).
Unfortunately, since it's a corporately-owned service, the community that uses it has no control over
