...
class NotificationsConfig(AppConfig):
    ...
    def ready(self):
        ...
        """
        from django_nyt.utils import notify  # noqa: PLC0415
        from wiki.core.plugins import registry  # noqa: PLC0415
        from wiki.decorators import disable_signal_for_loaddata  # noqa: PLC0415
        from wiki.plugins.notifications import models  # noqa: PLC0415
