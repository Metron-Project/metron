...
class WikiSite:
    ...
    def __init__(self, name="wiki"):
        from wiki.views import accounts, article, deleted_list  # noqa: PLC0415
...
class DefaultWikiSite(LazyObject):
    def _setup(self):
        wiki_site_class = import_string(apps.get_app_config("wiki").default_site)
        self._wrapped = wiki_site_class()
