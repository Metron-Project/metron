...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"burst": "20/minute", "sustained": "5000/day"},
...
OPENCOLLECTIVE_API_KEY = config("OPENCOLLECTIVE_API_KEY")
OPENCOLLECTIVE_SLUG = config("OPENCOLLECTIVE_SLUG", default="metron")
